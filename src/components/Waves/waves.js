        ...
        <>
            ...
            {/* <!--Hexagons Container--> */}
                <div className='hexagons' ref={hexagons}>
                    <svg className="bg-background"  style={{transform: `translateX(${ offsetY * 0.8}px)scale(${scale})`}} width="1111" height="1237" viewBox="0 0 1111 1237" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g id="Group 1">
